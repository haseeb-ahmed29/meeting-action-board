...
A simple browser tool for turning meeting discussions into clear action items and ownership.

## Purpose

This repository was created as a practical project to explore the design and implementation of **Meeting Action Board**. It can be used as a learning reference, a starting point for further development, or a demonstration of the related business workflow.
...
3. Create an action item, assign an owner or status where available, and update the board as work progresses.
